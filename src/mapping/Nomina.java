...
public class Nomina  implements java.io.Serializable {
    ...
    public Integer getDiasBaja() {
        return this.diasBaja;
    }
    
    public void setDiasBaja(Integer diasBaja) {
        this.diasBaja = diasBaja;
    }
